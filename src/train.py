...
if config['experiment']['source'] == 'cmd':
    ...
    parser.add_argument('--model_name', default="ConditionedAE", type=str)
...
if args.comet:
    ...
    if args.model_name == "ConditionedAE":
        experiment.log_code('src/models/conditioned_ae.py')
...
#MODELS
from models.conditioned_ae import ConditionedAE
from models.conditioned_ae_coord import ConditionedAECoord
...
from models.unext3Ddet import UNext3DDet
from models.vnext3Ddet import VNext3DDet
from models.original_unet import UNetRon
from models.modules import DAFT, FiLM, TabAttention, TabularMLP
...
if args.seed != -1:
    ...
    #     NP_MAX = np.iinfo(np.uint32).max
    #     worker_seed = torch.initial_seed() % NP_MAX
...
for fold, (train_ids, test_ids) in enumerate(folds):
    ...
    if args.model_name == "UNet":
        ...
        # model = UNet(spatial_dims=3, in_channels=1, out_channels=args.classes, channels=feature_maps, strides=strides,
        #             norm="instance", tabular_config=TABULAR_CONFIG, bias=args.bias)
    ...
    elif args.model_name == "ConditionedAE":
        torch.manual_seed(args.seed)
        model = ConditionedAE(spatial_dims=3, in_channels=1, out_channels=args.classes, act='relu', norm='batch', bias=args.bias, tabular_module=args.tabular_module,
                          ...
                          is_inference_regression=args.is_inference_regression, is_log_conditioning=args.is_log_conditioning, regression_mlp_expansion=args.mlp_expansion,
    ...
    if args.is_log_flops:
        ...
        model_input = torch.ones(size=(1,1,224,224,160))
                    #    torch.ones(size=(1,512)))#required for tabular model
    ...
    with experiment.train():
        ...
        for epoch in range(args.start_epoch, args.epochs):
            ...
            with torch.no_grad():
                ...
                #TESTING
                # last test is performed based on best validation checkpoint while others on the current epoch model state
                if args.perform_test:
